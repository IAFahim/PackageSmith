...
public static class LiveGenerationManager
{
        ...
        HashSet<string> createdFiles)
    {
        ...
        var rootAdded = createdDirectories.Contains(packagePath);
        var rootStyle = rootAdded ? StyleManager.SuccessColor : StyleManager.MutedColor;
        var rootIcon = rootAdded ? StyleManager.IconSuccess : StyleManager.IconFolder;
