...
public static class StateMachine
{
	...
	private static void NewPackageFromTemplateFlow()
	{
		...
		if (!TemplateGeneratorLogic.TryGenerateFromTemplate(templatePath, outputPath, name, displayName, description, authorName, unityVersion, out var fileCount))
		{
	...
	private static void NewPackageFromScratchFlow(string? name = null, string? displayName = null, string? description = null, string? authorName = null, string? unityVersion = null)
	{
